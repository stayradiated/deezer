...
type Track struct {
	...
	Track_position      int      `json:"track_position,omitempty"`      // The position of the track in its album
	Disk_number         int      `json:"disk_number,omitempty"`         // The track's album's disk number
	Rank                int      `json:"rank,omitempty"`                // The track's Deezer rank
	Release_date        int      `json:"release_date,omitempty"`        // The track's release date
	Explicit_lyrics     bool     `json:"explicit_lyrics,omitempty"`     // Whether the track contains explicit lyrics
	...
	Available_countries []string `json:"available_countries,omitempty"` // List of countries where the track is available
